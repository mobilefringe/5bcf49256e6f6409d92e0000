...
<script>
    define(["Vue", "vuex", "moment", "moment-timezone", "vue-moment", "vue-meta", "vue-lazy-load", "vue-paginate", "json!site.json"], function(Vue, Vuex, moment, tz, VueMoment, Meta, VueLazyload, VuePaginate, Site) {
        Vue.use(Meta);
        Vue.use(VueLazyload);
        Vue.use(VuePaginate);
        return Vue.component("events-component", {
            ...
            computed: {
                ...
                events() {
                    ...
                    temp_promo = _.sortBy(temp_promo, ['start_date', 'end_date']);//_.sortBy(temp_promo, [function(o) { return o.start_date; }]);
                    return temp_promo;
                },
            },
            methods: {
