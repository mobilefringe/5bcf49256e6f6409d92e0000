			...
			<div class="row">
				...
				<div class="col-sm-8 promo_image_container text-left">
					<div class="col-sm-12 no_padding">
						...
						<mapplic-map ref="mapplic_ref" :height="350" :minimap= "false" :deeplinking="false" :sidebar="false" :hovertip="true" :maxscale= "5" :storelist="allStores" :floorlist="floorList" tooltiplabel="View Store Details" @updateMap="updatePNGMap"></mapplic-map>
					</div>
				</div>
			</div>
			<hr class="green_hr">
