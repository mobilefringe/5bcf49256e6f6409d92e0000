                    ...
                    <form class="form-horizontal padding_top_20" action="form-submit" @submit.prevent="validateBeforeSubmit">
                        <div class="form-group ">
                            ...
                            <div class="col-sm-12" :class="{'has-error': errors.has('email')}">
                                ...
                                <input id="email" v-model="form_data.email" v-validate="'required|email'" class="form-control" :class="{'input': true}" name="email" type="email" placeholder="email@email.com" data-vv-delay="500">
                            ...
                            <div class="col-xs-12" :class="{'has-error': errors.has('message')}">
                                ...
                                <textarea id="message" v-model="form_data.message" rows="4" v-validate="'required:true'" class="form-control" :class="{'input': true}" name="message" type="text" placeholder="Your Comment Here" data-vv-delay="500"></textarea>
            ...
            methods: {
                ...
                loadData: async function() {
                    try {
                        ...
                        let results = await Promise.all([this.$store.dispatch('LOAD_PAGE_DATA', {url: this.property.mm_host + "	/pages/thecentre-contact-us.json"}),this.$store.dispatch("getData", "repos")]);
                        return results;
                    } catch (e) {
