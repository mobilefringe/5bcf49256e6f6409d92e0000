                    ...
                    <form class="form-horizontal padding_top_20" action="form-submit" @submit.prevent="validateBeforeSubmit">
                        <div class="form-group ">
                            ...
                            <div class="col-xs-12" :class="{'has-error': errors.has('message')}">
                                ...
                                <textarea v-model="form_data.message" rows="4" v-validate="'required:true'" class="form-control" :class="{'input': true}" name="message" type="text" placeholder="Your Comment Here" data-vv-delay="500"></textarea>
