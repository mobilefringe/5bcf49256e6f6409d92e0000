<template>
    <div class="page_container" id="contact_us_container" v-if="currentContest"> <!-- Without an outer container div this template will not render -->
						...
						<div class="form-group account-btn text-left m-t-10 agreement">
						    ...
						    <div class="col-xs-12">
						        <label class="checkbox">
                                    ...
                                    I agree to the <a href = "/pages/thecentre-contest-rules-and-regulations" target="_blank"><u> rules and regulations</u></a>
                                </label>
						    </div>
